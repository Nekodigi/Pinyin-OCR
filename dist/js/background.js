...
//   }
// });
document.addEventListener("mouseup", () => __awaiter(void 0, void 0, void 0, function* () {
    let res = window.getSelection().toString();
    console.log(res);
